...
public final class ReuseCache : @unchecked Sendable {
    ...
    public func set< Reusable : ReuseTrait >(_ reusable: Reusable.Type, owner: Reusable.Owner, content: Reusable.Content) {
    ...
    public func get< Reusable : ReuseTrait >(_ reusable: Reusable.Type, owner: Reusable.Owner) -> Reusable.Content {
        let name = reusable.name(owner: owner)
