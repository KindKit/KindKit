...
public struct CheckExtComponent : Component {
    
    private let input: Input
    
    @ComponentsBuilder
    private let components: (String) -> [any Component]
    
    public init(
        _ input: Character,
        @ComponentsBuilder _ components: @escaping (String) -> [any Component]
    ) {
    ...
    public init(
        _ input: [String],
        @ComponentsBuilder components: @escaping (String) -> [any Component]
    ) {
...
public extension CheckExtComponent {
