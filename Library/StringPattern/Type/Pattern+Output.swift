...
extension Pattern {
    ...
    public struct Output : Equatable {
        ...
        public subscript< Key : RawRepresentable >(string key: Key) -> String? where Key.RawValue == String {
        ...
        public subscript< Key : RawRepresentable >(range key: Key) -> Range< String.Index >? where Key.RawValue == String {
