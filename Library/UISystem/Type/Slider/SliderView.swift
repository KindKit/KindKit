...
public extension SliderView {
    ...
    @inlinable
    @discardableResult
    func progressColor(on: () -> Color) -> Self {
        self.progressColor = on()
        return self
    }

    @inlinable
    @discardableResult
    func progressColor(on: (Self) -> Color) -> Self {
        self.progressColor = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func trackColor(on: (Self) -> Color) -> Self {
        self.trackColor = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func thumbImage(on: (Self) -> Image) -> Self {
        self.thumbImage = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func thumbColor(on: (Self) -> Color) -> Self {
        self.thumbColor = on(self)
        return self
    }
