...
public extension SwitchView {
    ...
    @inlinable
    @discardableResult
    func offColor(on: (Self) -> Color) -> Self {
        self.offColor = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func onColor(on: (Self) -> Color) -> Self {
        self.onColor = on(self)
        return self
    }
...
extension SwitchView : IViewSupportTransform {
}
