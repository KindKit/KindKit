...
public final class SpinnerView {
...
#endif
    public var size: StaticSize = .init(.fixed(40), .fixed(40)) {
        didSet {
...
public extension SpinnerView {
    ...
    @inlinable
    @discardableResult
    func activityColor(on: () -> Color?) -> Self {
        self.activityColor = on()
        return self
    }

    @inlinable
    @discardableResult
    func activityColor(on: (Self) -> Color?) -> Self {
        self.activityColor = on(self)
        return self
    }
    
}

extension SpinnerView : IView {
...
extension SpinnerView : IViewReusable {
...
extension SpinnerView : IViewSupportTransform {
}

#endif

extension SpinnerView : IViewSupportStaticSize {
}

extension SpinnerView : IViewSupportColor {
}

extension SpinnerView : IViewSupportAlpha {
}
