...
public extension StepperView {
    ...
    @inlinable
    @discardableResult
    func minValue(on: (Self) -> Double) -> Self {
        self.minValue = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func maxValue(on: (Self) -> Double) -> Self {
        self.maxValue = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func stepValue(on: (Self) -> Double) -> Self {
        self.stepValue = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func value(on: (Self) -> Double) -> Self {
        self.value = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func isAutorepeat(on: () -> Bool) -> Self {
        self.isAutorepeat = on()
        return self
    }

    @inlinable
    @discardableResult
    func isAutorepeat(on: (Self) -> Bool) -> Self {
        self.isAutorepeat = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func isWraps(on: (Self) -> Bool) -> Self {
        self.isWraps = on(self)
        return self
    }
...
extension StepperView : IViewSupportTransform {
}

#endif

extension StepperView : IViewSupportStaticSize {
}

extension StepperView : IViewSupportColor {
}

extension StepperView : IViewSupportAlpha {
}

extension StepperView : IViewSupportChange {
}
