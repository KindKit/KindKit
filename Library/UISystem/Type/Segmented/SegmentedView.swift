...
public extension SegmentedView {
    ...
    @inlinable
    @discardableResult
    func selected(on: (Self) -> Item?) -> Self {
        self.selected = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func preset(on: (Self) -> Preset?) -> Self {
        self.preset = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func selectedPreset(on: () -> Preset?) -> Self {
        self.selectedPreset = on()
        return self
    }

    @inlinable
    @discardableResult
    func selectedPreset(on: (Self) -> Preset?) -> Self {
        self.selectedPreset = on(self)
        return self
    }
