...
public extension PageIndicatorView {
    ...
    @inlinable
    @discardableResult
    func pageColor(on: (Self) -> Color?) -> Self {
        self.pageColor = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func currentPageColor(on: () -> Color?) -> Self {
        self.currentPageColor = on()
        return self
    }

    @inlinable
    @discardableResult
    func currentPageColor(on: (Self) -> Color?) -> Self {
        self.currentPageColor = on(self)
        return self
    }
