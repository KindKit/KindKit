...
public extension BlurView {
    ...
    @inlinable
    @discardableResult
    func style(on: () -> UIBlurEffect.Style) -> Self {
        self.style = on()
        return self
    }
    ...
    @inlinable
    @discardableResult
    func style(on: (Self) -> UIBlurEffect.Style) -> Self {
        self.style = on(self)
        return self
    }
...
extension BlurView : IViewReusable {
...
extension BlurView : IViewSupportTransform {
}

#endif

extension BlurView : IViewSupportAlpha {
}
