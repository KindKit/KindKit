...
public final class View {
    ...
    public var frame: KindGeometry.Rect = .zero {
        didSet {
...
public extension View {
    ...
    @inlinable
    @discardableResult
    func request(on: (Self) -> Request) -> Self {
        self.request = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func enablePinchGesture(on: () -> Bool) -> Self {
        self.enablePinchGesture = on()
        return self
    }

    @inlinable
    @discardableResult
    func enablePinchGesture(on: (Self) -> Bool) -> Self {
        self.enablePinchGesture = on(self)
        return self
    }
...
public extension View {
    ...
    @inlinable
    @discardableResult
    func onContentSize< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target) -> Void) -> Self {
    ...
    @inlinable
    @discardableResult
    func onBeginLoading< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target) -> Void) -> Self {
    ...
    @inlinable
    @discardableResult
    func onEndLoading< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target) -> Void) -> Self {
    ...
    @inlinable
    @discardableResult
    func onDecideNavigation< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target, URLRequest) -> NavigationPolicy?) -> Self {
