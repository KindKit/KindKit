...
extension Intersection2 {
    ...
    public static func possibly(_ line: Line2, _ box: AlignedBox2) -> Bool {
        guard box.isContains(line.origin) == false else { return true }
    ...
    public static func find(_ line: Line2, _ box: AlignedBox2) -> LineToAlignedBox? {
        let bcf = box.centeredForm
        let o = line.origin - bcf.center
        var t1 = Coordinate(Int.min)
        var t2 = Coordinate(Int.max)
    ...
    fileprivate static func _clip(_ d: Coordinate, _ n: Coordinate, _ t1: inout Coordinate, _ t2: inout Coordinate) -> Bool {
        if d > 0 {
            if n > d * t2 {
                return false
            } else if n > d * t1 {
...
public extension Line2 {
    ...
    @inlinable
    func intersection(_ other: AlignedBox2) -> Intersection2.LineToAlignedBox? {
