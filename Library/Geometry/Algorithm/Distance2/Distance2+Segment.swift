    ...
    public struct SegmentToSegment : Equatable {
        ...
        public init(
            ...
            self.init(
                segment1: segment1,
                segment2: segment2,
                squaredDistance: segment1.point.squaredLength(segment2.point)
            )
        }
...
fileprivate extension Distance2 {
    ...
    struct Closest {
        ...
        init(src: Coordinate, dst: Coordinate) {
            self.src = src
            self.dst = dst
        }
...
fileprivate extension Distance2 {
    ...
    @inline(__always)
    static func _clampedRoot(_ slope: Coordinate, _ h0: Coordinate, _ h1: Coordinate) -> Coordinate {
    ...
    @inline(__always)
    static func _classify(_ value: Coordinate) -> Int {
        if value <= 0 {
            return -1
        } else if value >= 1 {
            return +1
    ...
    @inline(__always)
    static func _intersection(_ root: Closest, _ classify: Classify, _ b: Coordinate,  _ f00: Coordinate, _ f10: Coordinate) -> Intersect {
        let edge: Classify
        let endSrc: Closest
        let endDst: Closest
        if classify.src < 0 {
    ...
    @inline(__always)
    static func _parameters(_ i: Intersect, _ b: Coordinate, _ c: Coordinate, _ e: Coordinate, _ g00: Coordinate, _ g10: Coordinate, _ g01: Coordinate, _ g11: Coordinate) -> Closest {
...
public extension Segment2 {
    ...
    @inlinable
    func distance(_ other: Segment2) -> Distance2.SegmentToSegment {
