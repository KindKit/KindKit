...
public final class View : IWidgetView {
    ...
    @MonadicField
    public var styleSheet: StyleSheetTrait {
        didSet {
    ...
    public init(
        styleSheet: StyleSheetTrait = .default()
    ) {
...
public extension View {
    ...
    @inlinable
    @discardableResult
    func text(on: () -> String) -> Self {
        self.blocks = Parser.blocks(on())
        return self
    }

    @inlinable
    @discardableResult
    func text(on: (Self) -> String) -> Self {
        self.blocks = Parser.blocks(on(self))
        return self
    }
