...
@Monadic
public final class AnyViewLayout : ILayout {
    ...
    private let _content: AnyItemLayout
    
    public init(_ content: any IView) {
...
public extension KindLayout.SequenceBuilder {
    ...
    static func buildExpression(_ component: any IView) -> some ILayout {
        return AnyViewLayout(component)
    }
