...
public final class StaticLayoutItem< Controller : IView, View : NativeView > : ILayoutItem {
    
    public unowned(unsafe) var layout: (any ILayout)?
    
    public unowned let controller: Controller
    ...
    public init(_ controller: Controller, _ view: View) {
