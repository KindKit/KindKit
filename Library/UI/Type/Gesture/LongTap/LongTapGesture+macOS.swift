...
extension KKLongTapGesture {
    ...
    final func kk_update(gesture: LongTapGesture) {
    ...
    final func kk_cleanup(gesture: LongTapGesture) {
        self.kkDelegate = nil
    }
...
extension KKLongTapGesture {
    ...
    final func kk_update(delays: Bool, button: Mouse.Button) {
    ...
    final func kk_update(numberOfTouchesRequired: UInt) {
        self.numberOfTouchesRequired = Int(numberOfTouchesRequired)
    }
    
    final func kk_update(minimumDuration: SecondsInterval) {
        self.minimumPressDuration = minimumDuration.timeInterval
    }
    
    final func kk_update(allowableMovement: Double) {
