...
extension KKEdgePanGesture {
    ...
    final func kk_update(gesture: EdgePanGesture) {
        ...
        self.kk_update(mode: gesture.mode)
        self.kkDelegate = gesture
    }
    
    final func kk_cleanup(gesture: EdgePanGesture) {
        self.kkDelegate = nil
    }
...
extension KKEdgePanGesture {
    ...
    final func kk_update(mode: EdgePanGesture.Mode) {
        switch mode {
