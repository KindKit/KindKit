...
final class KKGestureView : NSView {
...
extension KKGestureView {
    ...
    final func kk_update(view: GestureView) {
...
extension KKGestureView {
    ...
    final func kk_update(gestures: [IGesture]) {
        for gesture in self.kkGestures {
            self.removeGestureRecognizer(gesture.handle)
        }
    ...
    final func kk_add(gesture: IGesture) {
    ...
    final func kk_remove(gesture: IGesture) {
