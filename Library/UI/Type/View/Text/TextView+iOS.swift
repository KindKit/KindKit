...
extension KKTextView {
    ...
    final func kk_update(view: TextView) {
        self.kk_update(frame: view.frame)
        self.kk_update(attributed: view.attributedText.attributed)
...
extension KKTextView {
    ...
    final func kk_update(attributed: NSAttributedString) {
        self.attributedText = attributed
    }
    
    final func kk_update(numberOfLines: UInt) {
...
private extension KKTextView {
    ...
    final func _tapCharacterIndex() -> Int? {
