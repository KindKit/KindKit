...
extension KKShapeView {
    ...
    final func kk_update(view: ShapeView) {
    ...
    final func kk_cleanup(view: ShapeView) {
    }
...
extension KKShapeView {
    ...
    final func kk_update(path: Path2?) {
    ...
    final func kk_update(fill: ShapeView.Fill?) {
        CATransaction.kk_withoutActions({
            if let fill = fill {
    ...
    final func kk_update(stroke: ShapeView.Stroke?) {
        CATransaction.kk_withoutActions({
    ...
    final func kk_update(line: ShapeView.Line) {
        CATransaction.kk_withoutActions({
