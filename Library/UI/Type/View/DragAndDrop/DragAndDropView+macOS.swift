...
extension KKDragAndDropView {
    ...
    final func kk_update(view: DragAndDropView) {
    ...
    final func kk_cleanup(view: DragAndDropView) {
    }
...
extension KKDragAndDropView {
    ...
    final func kk_update(destination: DragAndDrop.Destination?) {
        self.kkDragDestination = destination
    }
    
    final func kk_update(source: DragAndDrop.Source?) {
