...
extension KKScrollView {
    ...
    final func kk_update< Layout : ILayout >(view: ScrollView< Layout >) {
    ...
    final func kk_cleanup< Layout : ILayout >(view: ScrollView< Layout >) {
...
private extension KKScrollView {
    ...
    final func _scrollIndicatorInset() -> UIEdgeInsets {
