...
public extension IViewSupportText {
    ...
    @inlinable
    @discardableResult
    func numberOfLines(on: () -> UInt) -> Self {
        self.numberOfLines = on()
        return self
    }

    @inlinable
    @discardableResult
    func numberOfLines(on: (Self) -> UInt) -> Self {
        self.numberOfLines = on(self)
        return self
    }
...
public extension IViewSupportText {
    ...
    @inlinable
    @discardableResult
    func onTap< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target, URL) -> Void) -> Self {
...
public extension IViewSupportText where Self : CompositorTrait, Body : IViewSupportText {
