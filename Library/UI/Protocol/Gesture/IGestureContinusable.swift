...
public extension IGestureContinusable {
    ...
    @inlinable
    @discardableResult
    func onBegin< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target) -> Void) -> Self {
    ...
    @inlinable
    @discardableResult
    func onChange< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target) -> Void) -> Self {
    ...
    @inlinable
    @discardableResult
    func onCancel< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target) -> Void) -> Self {
    ...
    @inlinable
    @discardableResult
    func onEnd< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target) -> Void) -> Self {
