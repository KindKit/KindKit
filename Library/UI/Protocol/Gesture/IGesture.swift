...
public extension IGesture {
    ...
    @inlinable
    @discardableResult
    func enabled(on: (Self) -> Bool) -> Self {
...
public extension IGesture {
    ...
    @inlinable
    @discardableResult
    func cancelsInView(on: () -> Bool) -> Self {
        self.cancelsInView = on()
        return self
    }

    @inlinable
    @discardableResult
    func cancelsInView(on: (Self) -> Bool) -> Self {
        self.cancelsInView = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func delaysBegan(on: (Self) -> Bool) -> Self {
        self.delaysBegan = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func delaysEnded(on: (Self) -> Bool) -> Self {
        self.delaysEnded = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func requiresExclusive(on: () -> Bool) -> Self {
        self.requiresExclusive = on()
        return self
    }

    @inlinable
    @discardableResult
    func requiresExclusive(on: (Self) -> Bool) -> Self {
        self.requiresExclusive = on(self)
        return self
    }
...
public extension IGesture {
    ...
    @inlinable
    @discardableResult
    func onShouldBegin< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target) -> Bool?) -> Self {
    ...
    @inlinable
    @discardableResult
    func onShouldSimultaneously< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target) -> Bool?) -> Self {
    ...
    @inlinable
    @discardableResult
    func onShouldSimultaneously< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target, NativeGesture) -> Bool?) -> Self {
        self.onShouldSimultaneously.add(target, closure)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func onShouldRequireFailure< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target) -> Bool?) -> Self {
    ...
    @inlinable
    @discardableResult
    func onShouldRequireFailure< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target, NativeGesture) -> Bool?) -> Self {
        self.onShouldRequireFailure.add(target, closure)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func onShouldBeRequiredToFailBy< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target) -> Bool?) -> Self {
    ...
    @inlinable
    @discardableResult
    func onShouldBeRequiredToFailBy< Target : AnyObject >(_ target: Target, _ closure: @escaping (Target, NativeGesture) -> Bool?) -> Self {
        self.onShouldBeRequiredToFailBy.add(target, closure)
        return self
    }
