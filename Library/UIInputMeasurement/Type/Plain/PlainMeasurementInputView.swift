...
public final class PlainMeasurementInputView< Unit : Dimension > {
    ...
    public var value: Measurement< Unit >? {
        set {
    ...
    private var _value: Measurement< Unit >?
...
public extension PlainMeasurementInputView {
    ...
    @inlinable
    @discardableResult
    func unitFont(on: (Self) -> Font) -> Self {
        self.unitFont = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func unitColor(on: (Self) -> Color) -> Self {
        self.unitColor = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func unitInset(on: (Self) -> Inset) -> Self {
        self.unitInset = on(self)
        return self
    }
    
    @inlinable
    @discardableResult
    func value(_ value: Measurement< Unit >) -> Self {
        self.value = value
        return self
    }
    ...
    @inlinable
    @discardableResult
    func value(on: () -> Measurement< Unit >) -> Self {
        self.value = on()
        return self
    }
    ...
    @inlinable
    @discardableResult
    func value(on: (Self) -> Measurement< Unit >) -> Self {
        self.value = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func textFont(on: (Self) -> Font) -> Self {
    ...
    @inlinable
    @discardableResult
    func textColor(on: (Self) -> Color) -> Self {
    ...
    @inlinable
    @discardableResult
    func editingColor(on: () -> Color?) -> Self {
        self.editingColor = on()
        return self
    }

    @inlinable
    @discardableResult
    func editingColor(on: (Self) -> Color?) -> Self {
        self.editingColor = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func placeholder(on: () -> String?) -> Self {
        self.placeholder = on()
        return self
    }
    ...
    @inlinable
    @discardableResult
    func placeholder(on: (Self) -> String?) -> Self {
    ...
    @inlinable
    @discardableResult
    func placeholderFont(on: () -> Font?) -> Self {
    ...
    @inlinable
    @discardableResult
    func placeholderFont(on: (Self) -> Font?) -> Self {
    ...
    @inlinable
    @discardableResult
    func placeholderColor(on: () -> Color?) -> Self {
    ...
    @inlinable
    @discardableResult
    func placeholderColor(on: (Self) -> Color?) -> Self {
    ...
    @inlinable
    @discardableResult
    func alignment(on: () -> Text.Alignment) -> Self {
        self.alignment = on()
        return self
    }
    ...
    @inlinable
    @discardableResult
    func alignment(on: (Self) -> Text.Alignment) -> Self {
    ...
    @inlinable
    @discardableResult
    func keyboard(on: () -> InputKeyboard?) -> Self {
        self.keyboard = on()
        return self
    }
    ...
    @inlinable
    @discardableResult
    func keyboard(on: (Self) -> InputKeyboard?) -> Self {
        self.keyboard = on(self)
        return self
    }
...
extension PlainMeasurementInputView : KKInputMeasurementPlainViewDelegate {
    ...
    func editing(_ view: KKInputMeasurementPlainView, value: NSMeasurement?) {
        guard let value = value as? Measurement< Unit > else {
            return
        }
