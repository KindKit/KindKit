...
extension PlainMeasurementInputView {
    
    struct Reusable : IReusable {
        
        typealias Owner = PlainMeasurementInputView< Unit >
        typealias Content = KKInputMeasurementPlainView

        static var reuseIdentificator: String {
            return "PlainMeasurementInputView"
        }
...
extension KKInputMeasurementPlainView {
    ...
    func update< Unit : Dimension >(view: PlainMeasurementInputView< Unit >) {
    ...
    func update< Unit : Dimension >(unit: Unit) {
        self.kkUnit = unit
    }
    ...
    func update< Unit : Dimension >(value: Measurement< Unit >?) {
    ...
    func update(textFont: Font, unitFont: Font?) {
        self.kkUnitFont = (unitFont ?? textFont).native
        self.kkInputView.font = textFont.native
    }
    
    func update(textColor: Color, unitColor: Color?) {
