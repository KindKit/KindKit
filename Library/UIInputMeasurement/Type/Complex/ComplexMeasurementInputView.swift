...
public final class ComplexMeasurementInputView< Unit : Dimension > {
    ...
    public var `default`: Measurement< Unit >? {
        didSet {
...
public extension ComplexMeasurementInputView {
    ...
    @inlinable
    @discardableResult
    func `default`(_ value: Measurement< Unit >?) -> Self {
        self.default = value
        return self
    }
    ...
    @inlinable
    @discardableResult
    func `default`(on: () -> Measurement< Unit >?) -> Self {
        self.default = on()
        return self
    }
    ...
    @inlinable
    @discardableResult
    func `default`(on: (Self) -> Measurement< Unit >?) -> Self {
