...
extension ComplexMeasurementInputView {
    
    struct Reusable : IReusable {
        
        typealias Owner = ComplexMeasurementInputView< Unit >
        typealias Content = KKInputMeasurementComplexView

        static var reuseIdentificator: String {
            return "ComplexMeasurementInputView"
        }
...
extension KKInputMeasurementComplexView {
    ...
    func update< Unit : Dimension >(view: ComplexMeasurementInputView< Unit >) {
    ...
    func update< Unit : Dimension >(parts: [ComplexMeasurementInputView< Unit >.Part]) {
    ...
    func update< Unit : Dimension >(`default`: Measurement< Unit >?, value: Measurement< Unit >?) {
