...
@Monadic
public final class AnyItemLayout : Layout {
    ...
    public init(_ content: any Item) {
    ...
    public func sizeOf(_ request: SizeRequest) -> Size {
        ...
        return self._content.sizeOf(request, content: self.content)
    }
...
private extension AnyItemLayout {
