...
public struct ArrayDecodeOptions< Element : CodingOptions > : CodingOptions {
...
extension ArrayDecodeOptions : DefaultCodingOptions where Element : DefaultCodingOptions {
...
public extension ArrayDecodeOptions {
...
public extension ArrayDecodeOptions where Self : DefaultCodingOptions {
