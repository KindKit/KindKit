...
public final class LessCondition< Left : Property, Right : Property > : OperatorCondition where Left.Value : Comparable, Left.Value == Right.Value {
...
fileprivate extension LessCondition {
