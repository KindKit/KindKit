...
public final class EqualCondition< Left : Property, Right : Property > : OperatorCondition where Left.Value : Equatable, Left.Value == Right.Value {
...
fileprivate extension EqualCondition {
