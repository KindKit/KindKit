...
public final class Loader {
    ...
    public init(
        ...
        self.cache = cache
        self.lockQueue = DispatchQueue(label: "KindRemoteImage.Loader")
...
extension Loader : @unchecked Sendable {
}
...
public extension Loader {
    ...
    func download(target: Target, query: Query, filter: Filter? = nil) {
