...
func XCTAssert< Layout : KindLayout.Layout >(
    layout : Layout,
...
func XCTAssertPass< Layout : KindLayout.Layout >(
    layout : Layout,
    available: DynamicSize,
    bounds: Size,
    ...
    if selfSize.isNearNotEqual(expectSize) {
...
func XCTAssertPass< Layout : KindLayout.Layout >(
    ...
    if manager.contentSize.isNearNotEqual(expectSize) {
...
func XCTAssertPass< Layout : KindLayout.Layout >(
    ...
    if managerFrames.count > expectFrames.count {
        for index in 0 ..< expectFrames.count {
            ...
            if cFrame.isNearNotEqual(eFrame) {
