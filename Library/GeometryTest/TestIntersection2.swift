...
class TestIntersection2 : XCTestCase {
    ...
    func testPossiblyCircleToCircle() {
        let c1 = Circle(origin: Point(x: -1, y: 0), radius: Distance(value: 1))
        let c2 = Circle(origin: Point(x: 1, y: 0), radius: Distance(value: 2))
        
        let result = KindGeometry.Intersection2.possibly(c1, c2)
        if result == false {
            XCTFail()
        }
    }
    ...
    func testFindCircleToCircle() {
        let c1 = Circle(origin: Point(x: -1, y: 0), radius: Distance(value: 2))
        let c2 = Circle(origin: Point(x: 1, y: 0), radius: Distance(value: 2))
        
        let result = KindGeometry.Intersection2.find(c1, c2)
        switch result {
        case .two(let p1, let p2):
            if p1.isNearNotEqual(Point(x: 0, y: 1.7320508075688772)) || p2.isNearNotEqual(Point(x: 0, y: -1.7320508075688772)) {
                XCTFail()
            }
        default:
            XCTFail()
    ...
    func testPossiblyLineToLine() {
        ...
        let result = KindGeometry.Intersection2.possibly(l1, l2)
        if result == false {
            XCTFail()
        }
    }
    ...
    func testFindLineToLine() {
        ...
        let result = KindGeometry.Intersection2.find(l1, l2)
        switch result {
        case .point(let data):
    ...
    func testPossiblyLineToBox() {
        ...
        let result = KindGeometry.Intersection2.possibly(l, b)
        if result == false {
            XCTFail()
        }
    }
    ...
    func testFindLineToBox() {
        ...
        let result = KindGeometry.Intersection2.find(l, b)
    ...
    func testPossiblyLineToSegment() {
        ...
        let result = KindGeometry.Intersection2.possibly(l, s)
        if result == false {
            XCTFail()
        }
    }
    ...
    func testFindLineToSegment() {
        ...
        let result = KindGeometry.Intersection2.find(l, s)
        switch result {
        case .one(let point):
    ...
    func testPossiblySegmentToSegment() {
        ...
        let result = KindGeometry.Intersection2.possibly(s1, s2)
        if result == false {
            XCTFail()
        }
    }
    ...
    func testFindSegmentToSegment() {
        ...
        let result = KindGeometry.Intersection2.find(s1, s2)
