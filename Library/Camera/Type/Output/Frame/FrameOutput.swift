...
public final class FrameOutput : Output {
...
#endif
    public private(set) var frame: Image? {
        didSet {
    ...
    public let onFrame = Signal< Void, Image >()
    ...
    private let _workQueue = DispatchQueue(label: "KindCamera.Output.Frame")
...
extension FrameOutput : Equatable {
...
extension FrameOutput : @unchecked Sendable {
}

extension FrameOutput {
    
    func frame(_ image: Image) {
