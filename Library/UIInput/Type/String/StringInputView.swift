...
public extension StringInputView {
    ...
    @inlinable
    @discardableResult
    func value(on: (Self) -> String) -> Self {
        self.value = on(self)
        return self
    }
    ...
    @inlinable
    @discardableResult
    func suggestion(on: () -> KindSuggestion.IEntity?) -> Self {
        self.suggestion = on()
        return self
    }
    ...
    @inlinable
    @discardableResult
    func suggestion(on: (Self) -> KindSuggestion.IEntity?) -> Self {
        self.suggestion = on(self)
        return self
    }
