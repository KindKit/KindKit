...
class TestForm : XCTestCase {
    ...
    func testCheckBox() {
        ...
        let field = Form.Field.Select(id: .init("field"), policy: .any)
            .mandatory(.const(true))
            .items(items)
    ...
    func testAll() {
        ...
        let items2: [IFormField] = [
            .static(id: .init("field_2_item_1"), value: 1),
            .static(id: .init("field_2_item_2"), value: 2),
            .static(id: .init("field_2_item_3"), value: 3)
        ]
        let field2 = Form.Field.Select(id: .init("field_2"), policy: .any)
            .mandatory(.const(true))
            .items(items2)
        
        let field3 = Form.Field.Sequence(id: .init("field_3"), policy: .all)
            .mandatory(.const(true))
            .items([ field1, field2 ])
    ...
    func testAny() {
        ...
        let field3 = Form.Field.Sequence(id: .init("field_3"), policy: .any)
            .mandatory(.const(true))
            .items([ field1, field2 ])
    ...
    func testDouble() {
        let field = Form.Field.Dynamic(id: .init("double"), value: 0)
            .mandatory(.const(true))
            .validator({
                return $0 > 1 && $0 < 5
            })
    ...
    func testString() {
        let field = Form.Field.Dynamic(id: .init("string"), value: "")
            .mandatory(.const(true))
            .validator({
