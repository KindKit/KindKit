...
class TestIntersection2 : XCTestCase {
    ...
    func testPossiblyCircleToCircle() {
        ...
        let result = KindMath.Intersection2.possibly(c1, c2)
        if result == false {
            XCTFail()
        }
    }
    ...
    func testFindCircleToCircle() {
        ...
        let result = KindMath.Intersection2.find(c1, c2)
        switch result {
    ...
    func testPossiblyLineToLine() {
        ...
        let result = KindMath.Intersection2.possibly(l1, l2)
        if result == false {
            XCTFail()
        }
    }
    ...
    func testFindLineToLine() {
        ...
        let result = KindMath.Intersection2.find(l1, l2)
        switch result {
        case .point(let data):
    ...
    func testPossiblyLineToBox() {
        ...
        let result = KindMath.Intersection2.possibly(l, b)
        if result == false {
            XCTFail()
        }
    }
    ...
    func testFindLineToBox() {
        ...
        let result = KindMath.Intersection2.find(l, b)
    ...
    func testPossiblyLineToSegment() {
        ...
        let result = KindMath.Intersection2.possibly(l, s)
        if result == false {
            XCTFail()
        }
    }
    ...
    func testFindLineToSegment() {
        ...
        let result = KindMath.Intersection2.find(l, s)
        switch result {
        case .one(let point):
    ...
    func testPossiblySegmentToSegment() {
        ...
        let result = KindMath.Intersection2.possibly(s1, s2)
        if result == false {
            XCTFail()
        }
    }
    ...
    func testFindSegmentToSegment() {
        ...
        let result = KindMath.Intersection2.find(s1, s2)
