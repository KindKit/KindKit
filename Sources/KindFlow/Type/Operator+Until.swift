...
public extension Operator {
    ...
    final class Until< Input : IResult, Pipeline : IPipeline > : IOperator {
...
public extension Operator.Until {
...
private extension Operator.Until {
...
public extension IBuilder {
    ...
    func run< Pipeline : IPipeline >(
        pipeline: Pipeline,
        until: @escaping (Result< Tail.Output.Success, Tail.Output.Failure >, Pipeline.Output.Success?) -> Operator.Until< Tail.Output, Pipeline >.Resolve
    ) -> Chain< Head, Operator.Until< Tail.Output, Pipeline > > {
