...
public extension Operator {
    ...
    final class Condition1< Input : IResult, Output : IResult, Pipeline1 : IPipeline > : IOperator {
...
public extension Operator.Condition1 {
...
private extension Operator.Condition1 {
...
public extension IBuilder {
    ...
    >(
        ...
        then: Then
    ) -> Chain< Head, Operator.Condition1< Tail.Output, Then.Output, Then > > where
    ...
    >(
        `else`: Else
    ) -> Chain< Head, Operator.Condition1< Tail.Output, Else.Output, Else > > where
