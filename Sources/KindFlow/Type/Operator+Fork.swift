...
public extension Operator {
    ...
    final class Fork< Pipeline : IPipeline > : IOperator {
        ...
        private var _subscriptions: [ISubscription]!
...
private extension Operator.Fork {
...
public extension IBuilder {
    ...
    >(
        _ pipelines: Pipelines
    ) -> Chain< Head, Operator.Fork< Pipelines.Element > > where
        Pipelines.Element : IPipeline,
