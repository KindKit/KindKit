...
public extension Operator {
    ...
    final class Stack< Input : IResult, Pipeline : IPipeline > : IOperator where
...
public extension Operator.Stack {
...
private extension Operator.Stack {
...
public extension IBuilder {
    ...
    func fifo< Pipeline : IPipeline >(
        pipeline: Pipeline
    ) -> Chain< Head, Operator.Stack< Tail.Output, Pipeline > > where
