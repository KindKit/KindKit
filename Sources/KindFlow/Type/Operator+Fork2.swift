...
public extension Operator {
    ...
    final class Fork2< Pipeline1 : IPipeline, Pipeline2 : IPipeline > : IOperator where
...
private extension Operator.Fork2 {
...
public extension IBuilder {
    ...
    >(
        pipeline1: Pipeline1,
        pipeline2: Pipeline2
    ) -> Chain< Head, Operator.Fork2< Pipeline1, Pipeline2 > > where
