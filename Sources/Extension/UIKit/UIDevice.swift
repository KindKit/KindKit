...
public extension UIDevice {
    ...
    static let kk_pixelPerInch: Float = {
        ...
        case .phone:
            if let ppi = UIDevice._iPhonePpi(machine: UIDevice.kk_identifier) {
                return ppi
            }
            return UIScreen.main.scale == 2 ? 264 : 132
        case .pad:
            if let ppi = UIDevice._iPadPpi(machine: UIDevice.kk_identifier) {
                return ppi
            }
            ...
            return 326
        default:
            return 160 * Float(UIScreen.main.scale)
        }
    }()
