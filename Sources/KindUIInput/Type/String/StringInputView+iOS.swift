...
extension StringInputView {
    ...
    struct Reusable : IReusable {
        ...
        typealias Owner = StringInputView
...
final class KKInputStringView : UITextField {
    ...
    var kkSuggestion: KindSuggestion.IEntity? {
        ...
        var kkSuggestion: KindSuggestion.IEntity? {
            didSet {
                ...
                if let suggestion = self.kkSuggestion {
                    ...
                    self.kkSuggestionSubscribe = suggestion.onVariants.add(self, {
...
extension KKInputStringView {
    ...
    func update(view: StringInputView) {
    ...
    func update(keyboard: InputKeyboard?, suggestion: KindSuggestion.IEntity?) {
...
extension KKInputStringView : UITextFieldDelegate {
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString replacement: String) -> Bool {
        ...
        let info = StringInputView.ShouldReplace(
            text: oldText,
            range: range,
