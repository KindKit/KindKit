...
public extension UI.Layout.List {
    ...
    struct Helper {
        ...
        static func layout(
            ...
            switch direction {
            case .horizontal:
                guard items.count > 0 else { return Size(width: 0, height: bounds.height) }
            ...
            case .vertical:
                guard items.count > 0 else { return Size(width: bounds.width, height: 0) }
                var size = self._passSize(
        ...
        static func size(
            ...
            switch direction {
            case .horizontal:
                guard items.count > 0 else { return Size(width: available.width, height: 0) }
