...
extension PickerViewController : PHPickerViewControllerDelegate {
    ...
    public func picker(
        ...
        self._pipeline = KindFlow.Builder< [PHPickerResult], Never >()
            .dispatch(global: .userInitiated)
            .each()
            .fifo(
                pipeline: KindFlow.Builder< PHPickerResult, Never >()
...
public extension PickerViewController.Configuration.Mode {
    ...
    static let image = Self(rawValue: 1 << 0)
    static let video = Self(rawValue: 1 << 1)
    
}

fileprivate extension PickerViewController {
    
    static let fileStorage: FileStorage = {
