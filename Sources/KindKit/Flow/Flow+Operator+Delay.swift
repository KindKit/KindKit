...
public extension Flow.Operator.Delay {
...
private extension Flow.Operator.Delay {
...
public extension IFlowBuilder {
    ...
    func delay(
        queue: DispatchQueue,
        timeout: @escaping (Flow.Operator.Delay< Tail.Output >.Item) -> TimeInterval
    ) -> Flow.Chain< Head, Flow.Operator.Delay< Tail.Output > > {
