...
private extension Form.Field.Select.Valid {
    ...
    func _get() -> Bool {
        ...
        return self.policy.check(
            valid: self.value.kk_count(where: { $0.valid() }),
...
extension Form.Field.Select.Valid : IConditionObserver {
