...
final class KKCanvasView : NSView {
    ...
    var kkTapGestures: [UI.View.Canvas.Gesture : NSClickGestureRecognizer] = [:]
    var kkLongPressGestures: [UI.View.Canvas.Gesture : NSPressGestureRecognizer] = [:]
    var kkPanGestures: [UI.View.Canvas.Gesture : NSPanGestureRecognizer] = [:]
