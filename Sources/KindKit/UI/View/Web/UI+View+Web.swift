...
public extension UI.View {
    ...
    final class Web {
        ...
        public let onContentSize = Signal.Empty< Void >()
        public let onBeginLoading = Signal.Empty< Void >()
        public let onEndLoading = Signal.Empty< Void >()
        public let onDecideNavigation = Signal.Args< NavigationPolicy?, URLRequest >()
