...
public extension Container {
    ...
    final class Dialog : IDialogContainer {
        ...
        public var previous: IDialogContentContainer? {
            return self._previous?.container
        }
        public var current: IDialogContentContainer? {
        ...
        private var _interactiveDialogItem: Container.DialogItem?
        private var _interactiveDialogSize: Size?
#endif
        private var _items: [Container.DialogItem]
        private var _previous: Container.DialogItem?
        private var _current: Container.DialogItem? {
            didSet {
        ...
        public func close(container: IContainer, animated: Bool, completion: (() -> Void)?) -> Bool {
            if let container = container as? IDialogContentContainer {
        ...
        public func present(container: IDialogContentContainer, animated: Bool, completion: (() -> Void)?) {
            ...
            let item = Container.DialogItem(container, self._view.bounds.size)
        ...
        @discardableResult
        public func dismiss(container: IDialogContentContainer, animated: Bool, completion: (() -> Void)?) -> Bool {
...
extension Container.Dialog : IRootContentContainer {
}

extension Container.Dialog {
    ...
    func _present(current: Container.DialogItem?, next: Container.DialogItem, animated: Bool, completion: (() -> Void)?) {
    ...
    func _present(dialog: Container.DialogItem, animated: Bool, completion: (() -> Void)?) {
    ...
    func _dismiss(current: Container.DialogItem, previous: Container.DialogItem?, animated: Bool, completion: (() -> Void)?) {
        self._dismiss(dialog: current, animated: animated, completion: { [weak self] in
            guard let self = self else { return }
    ...
    func _dismiss(dialog: Container.DialogItem, animated: Bool, completion: (() -> Void)?) {
        if self.isPresented == true {
            self._layout.dialogItem = dialog
...
private extension Container.Dialog {
