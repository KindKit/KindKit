...
extension Container.Dialog {
    ...
    final class Layout : ILayout {
        ...
        var dialogItem: Container.DialogItem? {
            didSet {
        ...
        func layout(bounds: Rect) -> Size {
            ...
            if let dialog = self.dialogItem {
                ...
                case .idle:
                    ...
                    if let view = dialog.view as? IViewAlphable {
                        view.alpha = 1
                    }
                    if let background = dialog.background {
                        background.alpha = 1
...
extension Container.Dialog.Layout {
    ...
    @inline(__always)
    func _size(bounds: Rect, dialog: Container.DialogItem) -> Size {
    ...
    @inline(__always)
    func _presentRect(bounds: Rect, dialog: Container.DialogItem, size: Size) -> Rect {
    ...
    @inline(__always)
    func _idleRect(bounds: Rect, dialog: Container.DialogItem, size: Size) -> Rect {
        switch dialog.container.dialogAlignment {
    ...
    @inline(__always)
    func _dismissRect(bounds: Rect, dialog: Container.DialogItem, size: Size) -> Rect {
        switch dialog.container.dialogAlignment {
        case .topLeft: return Rect(topRight: bounds.topLeft, size: size)
        case .top: return Rect(bottom: bounds.top, size: size)
        case .topRight: return Rect(topLeft: bounds.topRight, size: size)
    ...
    @inline(__always)
    func _offset(dialog: Container.DialogItem, size: Size, delta: Point) -> Double {
        switch dialog.container.dialogAlignment {
    ...
    @inline(__always)
    func _size(dialog: Container.DialogItem, size: Size) -> Double {
        switch dialog.container.dialogAlignment {
    ...
    @inline(__always)
    func _progress(dialog: Container.DialogItem, size: Size, delta: Point) -> Percent {
