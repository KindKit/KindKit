...
public extension Intersection2 {
    ...
    static func possibly(_ line1: Line2, _ line2: Line2) -> Bool {
    ...
    static func find(_ line1: Line2, _ line2: Line2) -> LineToLine {
        let od = line2.origin - line1.origin
        let dp = line1.direction.dot(line2.direction.perpendicular)
        if dp !~ 0 {
...
public extension Line2 {
    ...
    @inlinable
    func intersection(_ other: Self) -> Intersection2.LineToLine {
