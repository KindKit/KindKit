...
public protocol ILayoutSequenceable : AnyObject {
...
public extension ILayoutSequenceable {
    
    @inlinable
    @discardableResult
    func content(@Builder builder: () -> [ILayout]) -> Self {
...
public extension ILayoutSequenceable where Self : IComposite, BodyType : ILayoutSequenceable {
