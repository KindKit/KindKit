...
@KindMonadic
public final class HStackLayout : ILayout {
    ...
    public func arrange(_ request: ArrangeRequest) -> Size {
        let frames = StackHelper.hFrames(
            purpose: request,
            spacing: self.spacing,
...
extension HStackLayout : ILayoutSequenceable {
...
extension HStackLayout : ISequenceCacheDelegate {
