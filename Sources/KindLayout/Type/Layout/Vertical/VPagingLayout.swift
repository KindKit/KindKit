...
@KindMonadic
public final class VPagingLayout : ILayout {
    ...
    public convenience init(@Builder builder: () -> [ILayout]) {
        self.init()
    ...
    public func arrange(_ request: ArrangeRequest) -> Size {
        let frames = PagingHelper.vFrames(
            purpose: request,
            content: self._sequence
        )
...
extension VPagingLayout : ILayoutSequenceable {
...
extension VPagingLayout : ISequenceCacheDelegate {
