...
@KindMonadic
public final class FillLayout< ContentType : ILayout > : ILayout {
    ...
    public func sizeOf(_ request: SizeRequest) -> Size {
        ...
        return content.sizeOf(request
            .override(width: request.container.width, height: request.container.height)
        )
    }
