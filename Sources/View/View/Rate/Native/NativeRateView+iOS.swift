...
final class NativeRateView : UIView {
    ...
    private var _rounding: RateViewRounding {
        didSet {
...
extension NativeRateView {
    ...
    func update(rounding: RateViewRounding) {
        self._rounding = rounding
    }
    
    func update(states: [RateViewState]) {
        self._states = states
    }
...
private extension NativeRateView {
    ...
    func _state(item: UInt) -> RateViewState? {
        ...
        var nearestState: RateViewState?
    ...
    func _update(layer: CALayer, state: RateViewState) {
        let image: UIImage
...
extension NativeRateView : ILayoutDelegate {
