...
public protocol ScrollViewHidingBarExtensionObserver : AnyObject {
    ...
    func changed(scrollViewExtension: ScrollViewHidingBarExtension)
...
public class ScrollViewHidingBarExtension {
    ...
    public var scrollView: IScrollView {
...
public extension ScrollViewHidingBarExtension {
...
extension ScrollViewHidingBarExtension : IScrollViewObserver {
    
    public func beginScrolling(scrollView: IScrollView) {
    }
    
    public func scrolling(scrollView: IScrollView) {
    ...
    public func endScrolling(scrollView: IScrollView, decelerate: Bool) {
        if decelerate == false {
            self._end()
        }
    }
    
    public func beginDecelerating(scrollView: IScrollView) {
    }
    
    public func endDecelerating(scrollView: IScrollView) {
        self._end()
    }
    
    public func scrollToTop(scrollView: IScrollView) {
        self._end(forceShow: false)
    }
    
}

private extension ScrollViewHidingBarExtension {
