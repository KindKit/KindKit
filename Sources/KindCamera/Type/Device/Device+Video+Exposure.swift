...
public extension Device.Video.Configuration {
    ...
    func isExposureSupported(_ feature: Device.Video.Exposure) -> Bool {
        return self.device.isExposureSupported(feature)
    }
    
    func exposure() -> Device.Video.Exposure? {
        return self.device.exposure()
    }
    
    func set(exposure: Device.Video.Exposure) {
        exposure.apply(self.device.device)
    }
    
}

extension Device.Video.Exposure {
