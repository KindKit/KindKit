...
public extension IBuilder {
    ...
    ) -> Chain< Head, Flow.Page< Tail.Output, SuccessType, FailureType, DataSourceType > > {
    ...
    >(
        dataSource: DataSourceType,
        success: @escaping (Tail.Output.Success, DataSourceType.Success) -> SuccessType
    ) -> Chain< Head, Flow.Page< Tail.Output, SuccessType, DataSourceType.Failure, DataSourceType > > where
    ...
    >(
        dataSource: DataSourceType,
        failure: @escaping (Tail.Output.Success, DataSourceType.Failure) -> FailureType
    ) -> Chain< Head, Flow.Page< Tail.Output, DataSourceType.Success, FailureType, DataSourceType > > {
    ...
    >(
        dataSource: DataSourceType
    ) -> Chain< Head, Flow.Page< Tail.Output, DataSourceType.Success, DataSourceType.Failure, DataSourceType > > where
        Tail.Output.Failure == Never
    {
