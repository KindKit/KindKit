...
public extension Flow {
    ...
    final class Pipeline< Input : IFlowResult, Output : IFlowResult > : IFlowPipeline {
        
        public typealias Input = Input
        public typealias Output = Output
        public typealias Result = Swift.Result< Output.Success, Output.Failure >
        
        private var _subscriptions: [Flow.Subscription< Input, Output >]
        private let _head: IFlowPipe
        private let _tail: Flow.Tail< Input, Output >
