...
private extension Operator.Condition.IfThen {
...
extension IFlowOperator {
    ...
    >(
        ...
        then: Then
    ) -> Operator.Condition.IfThen< Then > where
        Then.Input == Then.Output
    {
        let next = Operator.Condition.IfThen< Then >(`if`, then)
...
public extension Flow {
    ...
    >(
        ...
        then: Then
    ) -> Builder.Head< Operator.Condition.IfThen< Then > > where
        Input == Then.Input,
        Then.Input == Then.Output
    {
...
public extension Builder.Head {
    ...
    >(
        ...
        then: Then
    ) -> Builder.Chain< Head, Operator.Condition.IfThen< Then > > where
