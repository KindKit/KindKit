...
public protocol IViewEnableable : AnyObject {
    
    var isEnabled: Bool { set get }
    
}

public extension IViewEnableable where Self : IComposite, BodyType : IViewEnableable {
...
public extension IViewEnableable {
