...
final class KKCanvasView : UIView {
    ...
    var kkTapGestures: [CanvasView.Gesture : UITapGestureRecognizer] = [:]
    var kkLongPressGestures: [CanvasView.Gesture : UILongPressGestureRecognizer] = [:]
    var kkPanGestures: [CanvasView.Gesture : UIPanGestureRecognizer] = [:]
