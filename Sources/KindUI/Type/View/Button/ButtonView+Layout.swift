...
extension ButtonView {
    ...
    final class Layout : ILayout {
        ...
        var alignment: ButtonView.Alignment = .center {
            didSet { self.setNeedUpdate() }
        }
        ...
        var spinnerPosition: ButtonView.SpinnerPosition = .fill {
            didSet { self.setNeedUpdate() }
        }
        ...
        var secondaryPosition: ButtonView.SecondaryPosition = .left {
            didSet { self.setNeedUpdate() }
        }
...
private extension ButtonView.Layout {
    ...
    func _spinnerSize(_ available: Size, view: IView) -> Size {
    ...
    func _secondarySize(_ available: Size, view: IView) -> Size {
    ...
    func _primarySize(_ available: Size, view: IView) -> Size {
    ...
    func _frame(
        bounds: Rect,
        alignment: ButtonView.Alignment,
        primarySize: Size,
        secondaryPosition: ButtonView.SecondaryPosition,
