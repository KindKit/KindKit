...
@KindMonadic
public final class ScrollView< LayoutType : ILayout > : IView, IViewDynamicSizeable, IViewContentable, IViewScrollable, IViewZoomable, IViewEnableable, IViewColorable, IViewAlphable {
    ...
    public init() {
        ...
        self._layout.manager.onContentSize(self, { $0._onContentSize() })
