...
public final class DateInputView {
    ...
    public var formatter = StringFormatter.Date().format("MM-dd-yyyy HH:mm") {
        didSet {
...
public extension DateInputView {
    ...
    @inlinable
    @discardableResult
    func formatter(_ value: KindCore.StringFormatter.Date) -> Self {
    ...
    @inlinable
    @discardableResult
    func formatter(_ value: (Self) -> KindCore.StringFormatter.Date) -> Self {
    ...
    @inlinable
    @discardableResult
    func minimum(_ value: (Self) -> Date?) -> Self {
    ...
    @inlinable
    @discardableResult
    func maximum(_ value: (Self) -> Date?) -> Self {
    ...
    @inlinable
    @discardableResult
    func `default`(_ value: (Self) -> Date?) -> Self {
    ...
    @inlinable
    @discardableResult
    func value(_ value: (Self) -> Date?) -> Self {
    ...
    @inlinable
    @discardableResult
    func textFont(_ value: (Self) -> KindGraphics.Font) -> Self {
    ...
    @inlinable
    @discardableResult
    func textColor(_ value: (Self) -> KindGraphics.Color) -> Self {
    ...
    @inlinable
    @discardableResult
    func placeholderFont(_ value: (Self) -> KindGraphics.Font?) -> Self {
    ...
    @inlinable
    @discardableResult
    func placeholderColor(_ value: (Self) -> KindGraphics.Color?) -> Self {
    ...
    @inlinable
    @discardableResult
    func alignment(_ value: (Self) -> KindGraphics.Text.Alignment) -> Self {
...
extension DateInputView : IViewTransformable {
}

#endif

extension DateInputView : IViewStaticSizeable {
}
...
extension DateInputView : KKInputDateViewDelegate {
    
    func beginEditing(_ view: KKInputDateView) {
        self.onBeginEditing.emit()
    }
    
    func editing(_ view: KKInputDateView, value: Date) {
        self._value = value
        self.onEditing.emit()
    }
