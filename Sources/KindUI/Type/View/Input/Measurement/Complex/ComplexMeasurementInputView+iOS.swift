...
extension ComplexMeasurementInputView {
    ...
    struct Reusable : IReusable {
        ...
        typealias Owner = ComplexMeasurementInputView< UnitType >
...
extension KKInputMeasurementComplexView {
    ...
    func update< UnitType : Dimension >(view: ComplexMeasurementInputView< UnitType >) {
    ...
    func update< UnitType : Dimension >(parts: [ComplexMeasurementInputView< UnitType >.Part]) {
