...
public final class ExpandLayout : ILayout {
...
public extension ExpandLayout {
    ...
    @inlinable
    @discardableResult
    func detail(_ value: IView?) -> Self {
        self.detail = value
        return self
    }
    ...
    @inlinable
    @discardableResult
    func detail(_ value: (Self) -> IView?) -> Self {
