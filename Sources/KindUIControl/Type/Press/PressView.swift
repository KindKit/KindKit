...
public final class PressView< ContentType : ILayout > : IComposite, IView {
    ...
    private let _onClick = Signal< Void, Mouse.Click >()

#elseif os(iOS)
    
    private var _shouldPress: Bool = true
    ...
    private let _onPress = Signal< Void, Void >()
...
extension PressView : IViewDynamicSizeable {
}

extension PressView : IViewContentable {
}

extension PressView : IViewChangeable {
}

extension PressView : IViewHighlightable {
}

extension PressView : IViewSelectable {
}

extension PressView : IViewEnableable {
}

extension PressView : IViewAlphable {
}

#if os(macOS)

extension PressView : IViewClickable {
    
    public var shouldClick: [Mouse.Button] {
        set { self._shouldClick = newValue }
        get { self._shouldClick }
    }
    
    public var onClick: Signal< Void, Mouse.Click > {
        self._onClick
    }
...
private extension PressView {
    ...
    func _on(mouse: Mouse) {
        ...
        for click in clicks {
            guard self.shouldClick(button: click.button) == true else { return }
            self._onClick.emit(click)
        }
    }
...
extension PressView : IViewPressable {
    
    public var shouldPress: Bool {
        set { self._shouldPress = newValue }
        get { self._shouldPress }
    }
    
    public var onPress: Signal< Void, Void > {
        self._onPress
    }
