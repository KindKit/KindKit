...
public extension Graphics.Node {
    ...
    enum Move {
        ...
        case front
        case back
        case before(Graphics.Node)
        case after(Graphics.Node)
...
public extension Graphics.Node {
    ...
    func move(node: Graphics.Node, to: Move) {
    ...
    func insert(node: Graphics.Node) {
    ...
    func remove(node: Graphics.Node) {
...
private extension Graphics.Node {
