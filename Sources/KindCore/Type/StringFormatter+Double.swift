...
public extension IFormatter where Self == StringFormatter.Double< Swift.Float > {
...
public extension IFormatter where Self == StringFormatter.Double< Swift.Double > {
...
public extension IFormatter where Self == StringFormatter.Double< Swift.Float32 > {
...
public extension IFormatter where Self == StringFormatter.Double< Swift.Float64 > {
